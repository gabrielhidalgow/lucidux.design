            ...
            <div className="flex flex-col items-center gap-2 transform z-10 animate-[float_4s_ease-in-out_infinite]">
                <div className="relative">
                    ...
                    <div className="w-20 h-16 rounded-t-2xl rounded-br-2xl rounded-bl-sm gradient-border-card shadow-[0_0_30px_-5px_rgba(var(--accent-rgb),0.25)] flex items-center justify-center gap-1.5 relative">
                        ...
                        <div className="w-2 h-2 bg-[var(--color-accent)] rounded-full animate-[typing-bounce_1s_infinite] [animation-delay:0.2s]"></div>
                        <div className="w-2 h-2 bg-[var(--color-accent)] rounded-full animate-[typing-bounce_1s_infinite] [animation-delay:0.4s]"></div>
                    ...
                    <div className="absolute -bottom-4 -right-4 animate-[float_3s_ease-in-out_infinite_0.5s]">
                        <MousePointer2 className="text-[var(--color-accent)] fill-[var(--color-accent)]" size={24} />
                    </div>
