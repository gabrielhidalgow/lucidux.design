...
export function FeaturedTestimonial() {
    ...
    return (
        <section className="py-24 md:py-32 bg-[var(--color-background)] relative overflow-hidden" ref={ref}>
            <div className="absolute inset-0 bg-grid [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black_70%),linear-gradient(to_bottom,black_0%,black_80%,transparent_100%)] [mask-composite:intersect] pointer-events-none" />
