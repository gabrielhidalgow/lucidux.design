...
const jsonLd = {
  ...
  "@graph": [
    ...
    // ProfessionalService
    {
      ...
      name: "Lucidux Design",
      description: "Sydney-based fractional UX/UI designer for technical founders building AI products. Specializing in user journey optimization, usability improvements, and scalable design systems. Embedded design partner without the full-time cost.",
      url: "https://lucidux.design",
      provider: { "@id": "https://lucidux.design/#organization" },
      serviceType: ["Fractional UX Design", "Fractional Product Design", "UX Audit", "Design Systems", "Conversion Optimization"],
      areaServed: [
    ...
    // LocalBusiness (for local search "Sydney UX designer")
    {
      ...
      name: "Lucidux Design",
      description: "Fractional UX/UI designer and design partner for startup founders in Sydney. Product design help, UX audits, usability testing, and design systems without the full-time hire.",
      url: "https://lucidux.design",
      telephone: "",
    ...
    {
      "@type": "Service",
      name: "Fractional UX Design",
      description: "Embedded fractional UX designer for startups. Senior-level design expertise on a part-time, ongoing basis—like having a product designer on your team without the full-time cost.",
      provider: { "@id": "https://lucidux.design/#organization" },
      serviceType: "Fractional Design",
      areaServed: { "@type": "Country", name: "Australia" },
    },
    // FAQPage
    {
